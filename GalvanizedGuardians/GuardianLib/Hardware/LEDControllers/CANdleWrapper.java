...
import GuardianLib.Logging.Alert;
import GuardianLib.Logging.Alert.AlertType;
import GuardianLib.Logging.Faults.CANdleFaultsWrapper;
...
public class CANdleWrapper implements LEDControllerIO {
     ...
     *                 GuardianLib.Hardware.LEDControllers.Utility.CANDeviceDetails
     *                 CANDeviceDetails}
    ...
    /**
     * Updates the inputs for the LED controller I/O layer with the current CANdle
     * state.
     *
    ...
    /**
     * Sets the LED state to the specified CANdle state and duration. This method
     * allows specifying
    ...
    /**
     * Set a custom LED animation for each custom state of the robot. This method
     * will not
     * automatically turn off the LEDs; it will persist until explicitly set to a
     * different state.
     *
    ...
    /**
     * Periodically checks the timer and updates the LED state. This method is
     * typically called in
    ...
    /**
     * Checks for any faults that may have occurred in the CANdle hardware. If any
     * faults are
